...
CREATE TABLE `EVENT_DATERS` (
    ...
    PRIMARY KEY (`ID`),
    CONSTRAINT `EVENT_ID_fk_1` FOREIGN KEY (`EVENT_ID`) REFERENCES `EVENT` (`ID`),
    CONSTRAINT `DATER_ID_fk_1` FOREIGN KEY (`DATER_ID`) REFERENCES `DATER` (`ID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `EVENT_STORIES` (
    ...
    PRIMARY KEY (`ID`),
    CONSTRAINT `EVENT_ID_fk_5` FOREIGN KEY (`EVENT_ID`) REFERENCES `EVENT` (`ID`),
    CONSTRAINT `STORY_ID_fk_2` FOREIGN KEY (`STORY_ID`) REFERENCES `STORY` (`ID`),
...
CREATE TABLE `IMAGE` (
    ...
    PRIMARY KEY (`ID`),
    CONSTRAINT `DATER_ID_fk_2` FOREIGN KEY (`DATER_ID`) REFERENCES `DATER` (`ID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `EVALUATION_ANSWERS` (
   ...
   `ANSWER` text NOT NULL,
    ...
    CONSTRAINT `DATER_ID_fk_6` FOREIGN KEY (`DATER_ID`) REFERENCES `DATER` (`ID`),
...
CREATE TABLE `PROFILE_ANSWERS` (
   ...
   `ANSWER` text NOT NULL,
    PRIMARY KEY (`ID`),
    CONSTRAINT `DATER_ID_fk_10` FOREIGN KEY (`DATER_ID`) REFERENCES `DATER` (`ID`),
...
CREATE TABLE `STORY_ANSWERS` (
   ...
   `ANSWER` enum('A', 'B') DEFAULT 'A',
    PRIMARY KEY (`ID`),
    CONSTRAINT `DATERS_ID_fk_9` FOREIGN KEY (`DATER_ID`) REFERENCES `DATER` (`ID`),
...
CREATE TABLE `MESSAGES`(
    ...
    CONSTRAINT `DATER_ID_fk_7` FOREIGN KEY (`FROM_DATER_ID`) REFERENCES `DATER` (`ID`),
